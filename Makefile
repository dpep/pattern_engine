# pattern_engine — build / install / test helpers.
#
#   make            - same as `make help`
#   make build      - dev build      → ./target/debug/pattern_engine
#   make release    - optimized build → ./target/release/pattern_engine
#   make install    - cargo install --path . (into ~/.cargo/bin)
#   make uninstall  - cargo uninstall pattern_engine
